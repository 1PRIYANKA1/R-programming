...
//as a data member. Write necessary member functions to accept and display array elements
//of both the classes. Find and display average of both the array. (Use Friend function) 
